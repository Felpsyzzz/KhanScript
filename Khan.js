...
function setupMain(){
    function spoofQuestion() {
        const phrases = [ "🔥 Feito por Koceira(https://github.com/Felpsyzzz)!", "🤍 Feito por Zacarias(https://github.com/Felpsyzzz).", "☄️ Feito por Markes(https://github.com/Felpsyzzz) " ];
